    ...
    <section className="section">
      <div className="container-x">
        <div className="section-head">
          ...
          <p className="lead">
            Новости, травмы и сюжетные линии из live-источников. Лента помогает смотреть
            на прогноз через реальный контекст, а не только через цифры.
          </p>
        </div>
            ...
            {grid.length > 0 && (
              <>
                <div className="mb-5 flex items-center gap-4">
                  <h3 className="m-0 font-display text-2xl uppercase">Архив материалов</h3>
