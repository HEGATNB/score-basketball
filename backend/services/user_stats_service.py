...
def evaluate_challenges(stats: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    Each challenge has:
      id, icon, title, desc, progress (0-100), value (display), reward (XP),
    ...
    out.append({
        ...
        "icon": "🔥",
        "title": "5 ПОДРЯД",
        "desc": "Угадай 5 матчей без промахов",
        "progress": p,
    ...
    if completed >= min_n:
        ...
        out.append({
            "id": "accuracy_70",
            "icon": "🎯",
            "title": "ЛИГА АНАЛИТИКОВ",
            "desc": "70% точности (мин. 5 прогнозов)",
            "progress": p,
    ...
    out.append({
        ...
        "icon": "💎",
        "title": "АНДЕРДОГ",
        "desc": "Угадай 3 матча, где ИИ ставил на слабого",
    ...
    if rank:
        ...
        out.append({
            ...
            "desc": "Попади в топ-10 рейтинга",
            "progress": p,
            "value": f"#{rank}" + (" — РАЗБЛОКИРОВАНО" if rank <= 10 else ""),
            "reward": "+1000 XP",
            "color": "#ffb800",
            "locked": False,
        })
    ...
    out.append({
        ...
        "icon": "⚡",
        "title": "ПИКОВАЯ ФОРМА",
        "desc": "Лучший стрик за всё время",
    ...
    out.append({
        ...
        "icon": "📊",
        "title": "СЕРИЙНЫЙ",
        "desc": "Сделай 25 прогнозов всего",
